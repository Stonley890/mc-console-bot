...
## Installation
### 1. Download the file
1. Download the [script](mc-console-bot.py) from the repository.

### 2. Prepare Discord
1. Create a role that you want to allow access to console commands.
...
4. Find `CONSOLE_MASTER`. Replace `ROLE_NAME` with the name of the role you want to allow access to console commands.
...
1. Using the terminal or powershell, run `python3 path/to/mc-console-bot.py`, replacing **path/to/mc-console-bot.py** with the path to the script.
